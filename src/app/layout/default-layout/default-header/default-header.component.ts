...
@Component({
  ...
  imports: [ContainerComponent, IconDirective, HeaderNavComponent, NavItemComponent, NavLinkDirective, RouterLink, RouterLinkActive, NgTemplateOutlet, DropdownComponent, DropdownToggleDirective, AvatarComponent, DropdownMenuDirective, DropdownItemDirective, HeaderTogglerDirective, SidebarToggleDirective]
})
export class DefaultHeaderComponent extends HeaderComponent {
  ...
  onLogout() {
    ...
    this.router.navigateByUrl('/login').then(() => {
      this.location.replaceState('/login'); // clears history
    });
  }
}
